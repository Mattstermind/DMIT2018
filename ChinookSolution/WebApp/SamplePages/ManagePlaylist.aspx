...
<div>
    ...
    <div class="col-sm-2">
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            ...
            AutoPostBack="true" OnSelectedIndexChanged="MediaTypeDDL_SelectedIndexChanged">
    ...
    <div class="col-sm-10">
        ...
        <asp:LinkButton ID="DeleteTrack" runat="server"
            ...
            OnClientClick="return confirm('Are you sur you wish to delete the song(s)?')">
    ...
    <asp:ObjectDataSource ID="TrackSelectionListODS"
        runat="server"
        OldValuesParameterFormatString="original_{0}" 
        SelectMethod="Track_GetTrackByTrackAndId" 
        TypeName="ChinookSystem.BLL.TrackController"
        OnSelected="CheckForException">

        <SelectParameters>
            <asp:ControlParameter ControlID="TracksBy" PropertyName="Text" DefaultValue="zxcvds" Name="trcksby" Type="String"></asp:ControlParameter>
            <asp:ControlParameter ControlID="SearchArg" PropertyName="Text" DefaultValue="aacacaca" Name="searchargs" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
